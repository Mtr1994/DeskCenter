...
FlatToolButton::FlatToolButton(QWidget *parent) : QPushButton(parent)
{
    setMouseTracking(true);
}

FlatToolButton::FlatToolButton(int id, QWidget *parent) : QPushButton(parent), mID(id)
{
    setMouseTracking(true);
}

void FlatToolButton::setID(int id)
{
...
void FlatToolButton::mousePressEvent(QMouseEvent *event)
{
    mMousePressed = true;
    QPushButton::mousePressEvent(event);
}

void FlatToolButton::mouseReleaseEvent(QMouseEvent *event)
{
    mMousePressed = false;
    QPushButton::mouseReleaseEvent(event);
}

void FlatToolButton::paintMin()
{
...
void FlatToolButton::paintClose()
{
    QPainter painter(this);
